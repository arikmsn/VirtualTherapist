...
class Session(BaseModel):
    ...
    # Payment tracking (added migration 046)
...
class SessionSummary(BaseModel):
    ...
    # Source notes (text-generated summaries — added migration 046)
    notes_input = Column(Text, nullable=True)  # therapist's original text notes (when generated_from='text')
    ...
    ai_model = Column(Text)                  # model that generated this summary
